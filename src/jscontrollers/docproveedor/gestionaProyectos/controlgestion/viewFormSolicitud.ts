...
export default defineComponent({
    ...
    setup(_props, { emit }) {
        ...
        const array_tipo_proyecto = ref(['Gasto', 'Inversión']);
        const mensajeObservacion = ref('');
        ...
        const saveProyecto = async () => {
            ...
            formData.append('from', 'ControlGestion');
            formData.append('dataProyecto', JSON.stringify(localForm.value));
            formData.append('oldProyecto', JSON.stringify(injectShowModalForm.proyecto));
            formData.append('mensajeObservacion', mensajeObservacion.value);
            ...
            <template v-slot:body>
                <form id="formSolicitud">
                    <div class="row">
                        ...
                        <div class="col-md-3" v-if="localForm.value.codigoproyecto !== ''">
                    ...
                    <div class="row gap-3">
                        ...
                        <div class="col-md-4">
                            <div class="d-flex align-items-center">
                                <label for="tipoproyecto" class="form-label mb-0 me-2">Tipo de Proyecto</label>
                                <select
                                    id="tipoproyecto"
                                    v-model="localForm.value.tipo_proyecto"
                                    class="form-control"
                                    required>
                                    <option value="" disabled>Seleccione tipo de proyecto</option>
                                    <option v-for="(item, index) in array_tipo_proyecto" :key="index" :value="item">
                                        {{ item }}
                                    </option>
                                </select>
                            </div>
                    ...
                    <div class="row mt-3 p-2 border-warning border rounded">
                        <label for="motivo" class="form-label">Motivo de la modificación</label>
                        <textarea
                            class="form-control"
                            id="motivo"
                            v-model="mensajeObservacion"
                            rows="3"
                            placeholder="Ingrese una Motivo para la modificación"
                            required></textarea>
                    </div>
                </form>
            </template>
