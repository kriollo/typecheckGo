...
- Usa `--timeout <ms>` para definir el tiempo máximo de ejecución en milisegundos (por defecto: 10000).
- Aumenta este valor para proyectos grandes o entornos lentos.
